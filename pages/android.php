...
<?php 
$query = "SELECT * FROM `tasks` WHERE `type`='Android' and (`statusTask`='To Do' or `statusTask`='In Progress')";
$run = mysqli_query($con,$query);

$queryDone = "SELECT * FROM `tasks` WHERE `type`='Android' and `statusTask`='Done'";
...
border: none;
background: #e9e9ed;" onclick="sendAjaxDelete(<?php echo $data['id'];?>)">Delete</button></td><td>
...
<td><button style="padding: 0.6rem 1.5rem;
border: none;
background: #e9e9ed;" onclick="sendAjaxDelete(<?php echo $dataDone['id'];?>)">Delete</button></td>
</tr>
